...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scene = function (_Events) {
	    _inherits(Scene, _Events);
...
/***/ function(module, exports) {
	...
	var Events = function () {
	    ...
	    _createClass(Events, [{
	        ...
	        value: function addEventListener(ev, callback) {
	        ...
	        value: function removeEventListener(ev, callback) {
	            this.events = this.events || {};
	            if (this.events[ev]) {
	        ...
	        key: "fireEvent",
	        value: function fireEvent(ev, data) {
	            this.events = this.events || {};
	            if (this.events[ev]) {
	                for (var i = 0; i < this.events[ev].length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Entity = function (_Events) {
	    _inherits(Entity, _Events);
